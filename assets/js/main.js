    ...
    story2: {
        ...
        content: `
            <div class="story-part">
                <h5>[프롤로그 - 마들렌상점]</h5>
                <p>유니는 여느날처럼 아르바이트를 하고 머리를 하기위해 지하철을 타러가는 길, 커피값조차 사치로 느껴져 모닝라떼 의식도 포기한 날이었지만</p>
                
                <p>'오랜만에 가는 그녀의 헤어숍에 빈 손으로 갈순없지 ㅜ'</p>
                
                <p>주변에 다소 비싼 고급제과점들이 몇 군데 있었지만 좀 더 부담없이 살만한 곳이 없을까 두리번거리며 걷던와중에 발견한 곳. 바로 그랜마정미의 마들렌상점이다.<br>
                유니가 평소 움직이는 동선과 방향은 다르지만 꽤나 가까이 있던 그 가게를 그녀는 왜 한 번도 가보지 않았을까 생각하며 상점안을 들어섰다.</p>
                
                <p>밝은조명과 비비드한 컬러로 포인트를 준 귀여운가게.<br>
                그와 대비되게, 그레이컬러 헤어의 할머니들이 가게를 상징하는 유니폼을 입고 있었다.<br>
                유니가 느끼기에 세상 따뜻하고 순수한 미소로 손님을 맞이하던 할머니 세 명.</p>
                
                <p>그리고 분주하게 각자의 일을 했는데<br>
                마들렌과 마카롱, 쿠키등을 만들고 보관하는 주방을 맡은 순덕 _<br>
                가게 내부 정리와 관리를 주로 보는 혜숙 _ 메인 바와 손님응대를 도맡아 하는 정미 까지.</p>
                
                <p>유니는 서로의 시선이 마주쳤던 짧은 순간에 그랜마정미의 눈을 바라보며 이상하게도 깊은 연결감을 느꼈다. 마치 오래전부터 알고 지낸 사람처럼.</p>
                
                <p>좋은표현에 주저함이 없는 유니가 뜬금없이 웃으며 말했다.</p>
                
                <p>- 사장님 ~ 정말 멋지세요 ~ 이렇게 귀여운 가게는 정말 오랜만인거 같아요 !<br>
                귀엽다는 표현이 적절한가 싶은 유니였지만 그 이상 그 곳을 설명할수 있는 단어는 생각나지 않았다.</p>
                
                <p>- 감사합니다 ^^ 가까이 있으시면 자주 놀러오세요 ~<br>
                낮고 조용하지만 품격있는 목소리의 그녀가 말했다.</p>
                
                <p>한 편 주방에 들어간 순덕이 소리쳤다.<br>
                - 어휴 ,, 야 ! 이거 포장할 갯수가 안맞잖아 !!</p>
                
                <p>기분 좋은 생각을 한듯 미소를 머금은채 가게 구석구석을 체크하고 정리하던 혜숙이 깜짝 놀라며 목소리를 낮추라고 했는데 그 말을 하는 자신도 질수없다는듯 목소리가 커져있었다.</p>
                
                <p>유니는 살짝 소리내 웃었고</p>
                
                <p>흔히 벌어지는 일이라 익숙하다는듯의 체념어린 미소로 그들을 바라보던 정미는 마치 알고 있었던 사람처럼 유니가 좋아하는 따뜻한 카페라떼를 만들어 주었다.</p>
                
                <p>- 좀 시끄럽죠? 미안해요 ^^ 나는 부드러운 우유가 들어간 커피를 좋아하는데 어때요? 서비스 할께요. 혹시 안 좋아하시면 내가 마실려구 호호</p>
                
                <p>- 앗 정말요? 저 너무 너 ~~~ 무 좋아해요 !!<br>
                근데 이렇게 비싼커피 그냥 마셔도되요? 계산할께요 !</p>
                
                <p>- 아니에요 ^^ 오늘은 마들렌과 마카롱값만 받을게요<br>
                라떼 좋아한다니 다행이네 ~</p>
                
                <p>카페라떼를 너무 좋아해서 한 여름에도 그것을 고집하던 유니는 기쁜 마음으로 커피를 받았다. 마침 커피값을 아끼겠다고 마시지 못했던터라 더욱 감동이 밀려왔다.</p>
                
                <p>더군다나 엄마뻘 이상의 어른에게 받은 존중과 기분좋은 매너는 반나절의 피로를 가시게 만들어주기 충분했다.</p>
                
                <p>- 감사합니다. 사장님 ! 자주 올께요 !!</p>
                
                <p>'고작 마들렌 두 개와 마카롱 두 개를 샀을 뿐인데…'</p>
                
                <p>치른 값에 비해 넘치는 기쁨을 받았다고 생각하며,<br>
                유니는 미루고 미뤘던 미용실을 향해 상점을 나왔다.</p>
