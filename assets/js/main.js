    ...
    story2: {
        ...
        content: `
            <div class="story-part">
                <h4>1장</h4>
                <p>유니는 여느 날처럼 아르바이트를 마치고 머리를 하기 위해 지하철을 타러 가는 길이었다.</p>

                <p>커피값조차 사치로 느껴져 모닝라떼 의식도 포기한 날이었지만,</p>

                <p>'오랜만에 가는 그녀의 헤어숍에 빈손으로 갈 순 없지 ㅜ'</p>

                <p>주변에는 다소 비싼 고급 제과점들이 몇 군데 있었고, 조금 더 부담 없이 살 만한 곳이 없을까 두리번거리며 걷던 와중에 발견한 곳이 있었다.</p>

                <p>바로 그랜마정미의 마들렌 상점이었다.</p>

                <p>유니가 평소 움직이는 동선과는 방향이 달랐지만, 생각보다 꽤 가까운 곳에 있던 그 가게를 그녀는 왜 한 번도 가보지 않았을까 생각하며 상점 안으로 들어섰다.</p>

                <p>밝은 조명과 비비드한 컬러로 포인트를 준 귀여운 가게. 그와 대비되게 그레이 컬러의 헤어를 한 할머니들이 가게를 상징하는 유니폼을 입고 있었다.</p>

                <p>유니가 느끼기에 세상에서 가장 따뜻하고 순수한 미소로 손님을 맞이하던 할머니는 모두 세 명이었다.</p>

                <p>마들렌과 마카롱, 쿠키 등을 만들고 보관하는 주방을 맡은 순덕,<br>
                가게 내부 정리와 관리를 주로 보는 혜숙,<br>
                그리고 메인 바와 손님 응대를 도맡아 하는 정미까지.</p>

                <p>유니는 서로의 시선이 마주쳤던 짧은 순간, 그랜마정미의 눈을 바라보며 이상하게도 깊은 연결감을 느꼈다. 마치 오래전부터 알고 지낸 사람처럼.</p>

                <p>좋은 표현에 주저함이 없는 유니는 뜬금없이 웃으며 말했다.</p>

                <p>"사장님, 정말 멋지세요. 이렇게 귀여운 가게는 정말 오랜만인 것 같아요."</p>

                <p>귀엽다는 표현이 적절한가 싶었지만, 그 이상 이곳을 설명할 수 있는 단어는 떠오르지 않았다.</p>

                <p>"감사합니다. 가까이 있으시면 자주 놀러 오세요."</p>

                <p>낮고 조용하지만 품격 있는 목소리의 그녀가 말했다.</p>

                <p>한편, 주방에 있던 순덕이 소리쳤다.</p>

                <p>"어휴, 야! 이거 포장할 개수가 안 맞잖아!"</p>

                <p>기분 좋은 생각을 한 듯 미소를 머금은 채 가게 구석구석을 체크하고 정리하던 혜숙이 깜짝 놀라 목소리를 낮추라며 말했지만, 그 말조차 지기 싫다는 듯 점점 커지고 있었다.</p>

                <p>유니는 살짝 소리 내 웃었다.</p>

                <p>흔히 벌어지는 일이라는 듯 체념 어린 미소로 그들을 바라보던 정미는 마치 알고 있었던 사람처럼 유니가 좋아하는 따뜻한 카페라떼를 만들어 주었다.</p>

                <p>"좀 시끄럽죠? 미안해요. 나는 부드러운 우유가 들어간 커피를 좋아하는데, 어때요? 서비스로 드릴게요. 혹시 안 좋아하시면 내가 마시려고요."</p>

                <p>"앗, 정말요? 저 너무, 너무 좋아해요! 근데 이렇게 비싼 커피 그냥 마셔도 돼요? 계산할게요."</p>

                <p>"아니에요. 오늘은 마들렌이랑 마카롱 값만 받을게요. 라떼 좋아한다니 다행이네요."</p>

                <p>카페라떼를 너무 좋아해서 한여름에도 그것만 고집하던 유니는 기쁜 마음으로 커피를 받았다.</p>

                <p>마침 커피 값을 아끼겠다고 마시지 못했던 터라 감동은 더 크게 밀려왔다.</p>

                <p>게다가 엄마 뻘 이상의 어른에게 받은 존중과 기분 좋은 매너는 반나절의 피로를 가시게 하기에 충분했다.</p>

                <p>"감사합니다, 사장님. 자주 올게요."</p>

                <p>'고작 마들렌 두 개와 마카롱 두 개를 샀을 뿐인데…'</p>

                <p>치른 값에 비해 넘치는 기쁨을 받았다고 생각하며 유니는 미루고 미뤘던 미용실을 향해 상점을 나왔다.</p>

                <p>그날 이후, 유니의 동선은 조금 달라졌다.</p>
            ...
            <div class="story-part">
                <h4>2장</h4>
                <p>출근 시간이 임박해 유니는 허겁지겁 레스토랑을 향해 뛰었다.</p>

                <p>밑창이 닳아 모양이 흐트러진 십 년은 훌쩍 넘은 컨버스와 자주 빨아도 금세 꼬질해지는 아이보리색 에코백은 어느새 그녀의 트레이드마크가 되어 있었다.</p>

                <p>계절마다 교복처럼 입고 다니는 옷도 한두 벌이면 충분했다.</p>

                <p>유니는 비교적 소탈한 성격이었지만 여자답게 꾸미는 것 또한 좋아했다.</p>

                <p>말끔하고 근사하게 갖춰 입고 출근하던 시절과 한껏 여성스럽게 꾸미고 외출하던 때가 문득 아쉽게 느껴지기도 했지만,</p>

                <p>그럼에도 그녀는 지금의 자신이 마음에 들었다.</p>

                <p>"안녕하세요, 사장님."</p>

                <p>"어서 오이소."</p>

                <p>레스토랑 사장은 업력 삼십 년이 넘은 오너 셰프였다. 한때는 직원이 스무 명쯤 되던 레스토랑의 수석 셰프였고, 지금은 동네 한켠에서 혼자 가게를 꾸려가고 있었다.</p>

                <p>표현은 까칠했지만 정이 많은, 전형적인 경상도 사람이었다.</p>

                <p>그날은 유난히 가게가 조용했다. 유니는 묵묵히 쓸고 닦으며 홀을 지켰고, 사장은 식재료를 다듬고 준비하는 하루의 루틴을 이어갔다.</p>

                <p>모든 준비를 마친 사장은 주방 한켠에 앉아 정치 유튜브를 틀어 놓았다.</p>

                <p>투덜거리는 소리가 간간이 흘러나왔지만, 그 역시 가게 운영의 일부처럼 익숙한 풍경이었다.</p>

                <p>유니에게 그 소리는 음악 소리와 함께 하루를 채우는 배경음처럼 흘러갔다.</p>

                <p>예약 팀 외에는 조용히, 별다른 이슈 없이 근무 시간이 지나갔다.</p>

                <p>적당한 긴장감이 도는 바쁨 속에서 오히려 활력이 생기던 유니는 퇴근 시간에 맞춰 유니폼을 벗을 즈음 왠지 모르게 에너지가 빠진 상태였다.</p>

                <p>그리고 익숙한 걸음으로 향한 그곳.</p>

                <p>그랜마정미의 마들렌 상점은 문이 닫혀 있었다.</p>

                <p>아무 생각 없이 걸음을 옮겼던 유니는 잠시 그 앞에 서서 멍하니 안을 들여다보다 휴대폰으로 시간을 확인했다.</p>

                <p>'오늘은 좀 일찍 문을 닫으셨나 보네.'</p>
            </div>

            <div class="story-part">
                <h4>3장</h4>
                <p>깜깜한 도시. 지나다니는 차들마저 한가로워 보이는 시간에 유니는 또 다른 아르바이트를 하기 위해 집을 나섰다.</p>

                <p>오래전부터 인연이 있던 사람의 낡은 바. 주변은 많이 변했지만, 그곳만큼은 시간이 멈춘 듯 그대로였다.</p>

                <p>한때는 직원도 손님도 북적이던 가게였다고 들었지만 지금은 사장 혼자 텅 빈 공간을 지키고 있었다.</p>

                <p>사람이 없으니 가게는 유난히 넓어 보였고, 올드한 인테리어와 정리가 되지 않은 물건들 사이로 쾨쾨한 냄새가 났다.</p>

                <p>시각과 후각에 예민한 유니에게 그곳에서 일하는 건 썩 편한 경험은 아니었다.</p>

                <p>그럼에도 유니는 그 가게로 나갔다.</p>

                <p>변화도, 정리도 쉽지 않은 사장과 지금의 유니는 묘하게 비슷한 상태에 있었고, 서로는 딱 필요한 만큼만을 주고받고 있었다.</p>

                <p>오 년, 십 년 사이 어디서든 들어봤을 법한 익숙한 발라드가 어김없이 흘러나왔다.</p>

                <p>언제나 이어폰을 꽂고 다닐 정도로 음악 없이 못 사는 유니였지만, 일하면서 듣는 늘 똑같은 음악은 현타를 불러일으키기도 했다.</p>

                <p>사장이 특히 좋아하는 노래가 나와 볼륨을 조금 더 올리는 순간, 사장의 지인 커플이 들어왔다.</p>

                <p>조용한 가운데 찾아온 젊은 커플을 한껏 띄우며 사장이 직접 맞이해 이야기하는 동안,</p>

                <p>유니는 슬쩍 구석으로 가 며칠 전 가져와 챙겨 두었던 마들렌을 한 입 베어 물었다.</p>

                <p>'아… 감질나. 정미 씨가 만들어 준 커피 마시고 싶다.'</p>

                <p>손님들이 하나둘 들어차기 시작했다.</p>

                <p>사장이 지인 커플과 노닥거리는 동안 분주해진 유니는 더벅머리 단골손님이 주문한 온더락 위스키를 준비하며 테이블 쪽을 힐끔 봤다.</p>

                <p>그 순간, 깜짝 놀라 시선을 멈추고 잠시 숨을 고르듯 다시 집중해 보았다.</p>

                <p>어둑한 내부 속, 조명에 비친 그레이 헤어가 은근한 은빛으로 보이는 나이 지긋한 여자가 앉아 있었다.</p>

                <p>설마 하는 마음으로 다가간 유니는 익살스러운 말투로 웃으며 그녀의 방식대로 반가움을 쏟아냈다.</p>

                <p>"정미 씨! 맞네, 우리 그랜마정미. 와, 놀랐잖아요. 언제 온 거예요, 혼자예요?"</p>

                <p>사장과는 달리 지인이 오는 것에 반감이 있었던 유니는 그곳에서 일하는 걸 아는 사람이 거의 없었다.</p>

                <p>그런 그녀가 정미를 보는 순간, 사장이 지인 커플을 맞이하던 그 호들갑이 이해되었다.</p>

                <p>그녀가 반갑고, 그 상황이 웃겼다.</p>

                <p>시크하게, 아무렇지 않게 앉아 있는 이 할머니가 유니는 너무 귀여웠다.</p>

                <p>"여기서 보네. 프로 N잡러였구만."</p>

                <p>정미는 전혀 놀라지 않은 얼굴이었다.</p>

                <p>"순덕이랑 혜숙 할머니들은요?"</p>

                <p>"지긋지긋해."</p>

                <p>"안 그래도 상점 갔었는데 문 닫혀 있던데요."</p>

                <p>"피곤해서."</p>

                <p>"피곤한데 왜 나오셨어요?"</p>

                <p>"푸흡— 그만 떠들고, 상큼한 칵테일 한 잔 주세요, 선생님."</p>

                <p>유니는 더 묻지 않았고 바로 돌아와 칵테일을 준비했다.</p>

                <p>데킬라 선라이즈를 내려놓자 정미가 잔을 들여다봤다.</p>

                <p>"색이 정말 예쁘네."</p>

                <p>그 모습을 보며 유니는 왜인지 모를 미소를 지었다.</p>

                <p>잠시 앉을까 생각하던 찰나, 사장이 부르는 소리가 들렸다.</p>

                <p>'맞다. 나 일하고 있었지.'</p>

                <p>바의 장사는 대체로 조용했지만 손님이 몇 명이라도 있으면 유니는 혼자 바빴다.</p>

                <p>멍하니 있는 건 싫었지만 일의 경계가 흐려지는 것도 힘들었다.</p>

                <p>분주히 움직이다가 다시 테이블 쪽을 봤을 때 정미는 이미 가고 없었다.</p>

                <p>자리 정리를 하러 가 보니 누가 있었던 자리라고는 생각되지 않을 만큼 테이블은 말끔히 정돈돼 있었다.</p>

                <p>그 위에 빈 잔과 쿠폰이 놓여 있었다.</p>

                <p>유니가 자주 가는 카페의 쿠폰이었다.</p>

                <p>"아니, 이 할머니 진짜… 다 모은 쿠폰을 그냥 주고 간 거야? 자기 가게 놔두고 남의 집 커피 마시러 다니는 것도 웃긴데, 이걸 왜 나한테…"</p>
    ...
    story_p: {
        ...
        content: `
            ...
            <div class="story-part">
                ...
                그는 ‘그럼에도 불구하고’ 하고픈 것들이 인생에서 진짜라며 통찰 깃든 얘기를 했었다. 그리고 나를 만나는 것도 그중 하나라는 걸 알게 되었다</p>
                ...
                <p>혼란스러운 가운데 불만스러운 순간마다 논리적으로 설명할 자신이 없었다.<br>
                ...
                조용히 기다리다 보면 P가 하는 말에서 그를 알아갈 힌트를 많이 찾았다.<br>
            ...
            <div class="story-part">
                ...
                <p>P와 처음 서로에게 이성의 호감을 느끼고 만나기 시작했던 몇 해 전, 메시지를 주고받는 게 답답하다고 말한 적이 있는데 그날 나는 그의 기준에서 '연인에게 무례한 여자’가 되어버렸다.<br>
                ...
                우리는 서로를 정말 모른 채 그저 호감에 기대어 만났고, 얼마 안 돼 P는 항복했었다.<br>
...
function openBook(storyId) {
    ...
    if (story) {
        ...
        // Use rAF to ensure DOM is painted before calculating column layout.
        // Double-rAF guarantees the browser has completed at least one paint cycle.
